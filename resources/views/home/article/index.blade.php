...
<div class="blog-masthead">
    <div class="container">
        <ul class="nav navbar-nav navbar-left">
            ...
            <li>
                <a class="blog-nav-item" href="{{route('home.article.add')}}">写文章</a>
            </li>
            <li>
...
<div class="container">
    ...
    <div id="carousel-example" class="carousel slide" data-ride="carousel">
        ...
        <div>
                        ...
                        <div class="blog-post">
                            <h2 class="blog-post-title"><a href="/home/article/update/{{$item->id}}" >{{$item->title}}</a></h2>
                            <p class="blog-post-meta">{{$item->created_at}} <a href="/user/5">Kassandra Ankunding2</a></p>
