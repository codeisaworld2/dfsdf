...
<div class="container">
    ...
    <div class="col-sm-8 blog-main">
        <form action="/home/article/edit/{{$data->id}}" method="POST">
          ...
          <!--   <input type="hidden" name="_token" value="MESUY3topeHgvFqsy9EcM916UWQq6khiGHM91wHy"> -->
            ...
            <div class="form-group">
                <label>内容</label>
                <textarea id="content" name="body" class="form-control" style="height:400px;max-height:500px;"  placeholder="这里是内容">{{$data->body}}</textarea>
            </div>
